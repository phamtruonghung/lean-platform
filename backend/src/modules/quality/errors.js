/*
 * Error plumbing for the Quality Module — this Module's own copy, on purpose.
 ...
 * modules/maintenance/errors.js and modules/actions/errors.js by design: the
 * duplication is the seam, not an oversight. This is the fourth copy, and
 * issue #203 is the Module that earned it.
 */

// `code` is optional — see modules/people/errors.js's own comment on
// httpError for the full reasoning; mirrored here so the four Modules'
