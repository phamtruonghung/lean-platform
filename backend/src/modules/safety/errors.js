/*
 * Error plumbing for the Safety Module — this Module's own copy, on purpose.
 ...
 * alternative. Byte-similar to modules/people/errors.js,
 * modules/maintenance/errors.js, modules/actions/errors.js and
 * modules/quality/errors.js by design: the duplication is the seam, not an
 * oversight. This is the fifth copy, and issue #226 is the Module that earned
 * it.
 */

// `code` is optional — see modules/people/errors.js's own comment on
// httpError for the full reasoning; mirrored here so the five Modules'
